This is my first HTML/CSS project for Microverse precourse. 

I 've gained next new skills : 
- Learning about positioning object through position property
- Centering with margin auto
- Using classes and IDs to manipulate objects
